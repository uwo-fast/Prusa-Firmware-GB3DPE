...
> TODO: the latest PINDA Back Right Mount design is offset from nozzle by 0.86mm in Y and 2.3mm in X, but the firmware is still set to slightly different values from prior iteration of the mount. We will update the firmware to match the latest design once we have tested it.
